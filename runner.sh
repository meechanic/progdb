...
uwsgi --plugins=python --http-socket=0.0.0.0:"$PORT" --pidfile=/tmp/progdb.pid --home="$VENVPATH" --module=progdb.wsgi:application --chdir="$MAINDIRECTORY" --static-map /static="$SROOT"
